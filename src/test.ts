...
export const _totalQuiz = [
  13, 23, 34, 25, 12, 21, 32, 13, 13, 22, 12, 32, 29, 22, 12, 32, 29, 32, 32, 29, 32,
];

export const _totalRate = [
  4.32, 3.21, 4.11, 3.96, 4.87, 3.23, 3.52, 4.22, 3.96, 2.5, 3.23, 3.52, 4.22, 3.96, 2.5, 4.22,
  3.96, 2.5,
];
...
export const _questionTitle = [
  'Even outlining a scope of lecture program',
  'Medior online marketers operate on a more strategic level.',
  'Mediors are responsible for developing SEO plans, content calendars, advertising campaigns and email marketing campaigns.',
  'They develop branding processes, conduct complex competition studies and take a bird’s-eye view of the results achieved by the juniors and mediors.',
  'They also guide them in this. Often seniors also act as strategic marketing consultants for clients.',
  'The medior has sufficient knowledge to successfully perform executive tasks, but is often supported and supervised by a Senior.',
  'A junior is someone who has just started in the job market and has zero to two years of work experience.',
  'A senior is usually the one who guides a junior in his or her work and career.',
  'Seniors often hold a position as team leader, strategist or consultant.',
...
export const _questionContent = [
  ...
  'Once you make it from medior to senior, your salary will be above the average in your industry. You’ll usually earn over a thousand more euros than a junior and your salary will continue to grow every year, especially if you’re managing a team.',
  'That might sound like a huge difference, but it makes sense when you look at the years of dedication and work experience, more responsibilities and leadership capabilities.',
  'Are you making the step from junior to medior, or from medior to senior? And do you want to make sure you’re being compensated well? Then we recommend that you sit down with your employer and negotiate your salary.',
  'The more experience you build up, the more value you have for the company. By using concrete examples of how your work benefits the company, you can convince your employer to give you a raise.',
  ...
  'Work experience and years of service are both determining factors in your job level. After all, you can’t immediately start working as a medior or senior when you first start out in the job market. ',
  'However, your job level isn’t only determined by experience and years of service, it also depends on your qualities and commitment.  For example, there are very talented professionals who, after two years of work experience, perform significantly better than some colleagues who have been practicing the same profession for over five years.',
  ...
  'Junior developers solve minor bugs, assist in writing code and develop simple programs, websites or designs in, for example, html, css, javascript, php, python or C##. A junior developer often masters one or two programming languages.',
  'Medior developers have their own clients and projects, are responsible for debugging, independently write the code that is needed to get a program or website working, and have in-depth knowledge of one programming language, but can often also work well with various related programming languages.',
  ...
  'In digital marketing, the division between junior, medior and senior is present in almost every company. This division is important because the employer can determine which jobs, clients and projects are suitable for his or her employees based on this. Are you searching for a job as digital marketer? ',
